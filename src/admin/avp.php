								...
								<section>
									<form class="search-form" action="#">	
										...
										<div class="form-buttons">		
											...
											<button type="button" class="btn btn-outline-primary" style="height:38px; width: 150px;"  onclick="executeAVP()">Ejecutar</button>
							...
							<!-- Menu -->
								<nav id="menu">
									...
									<ul>
										...
										<li class="selected"><i class="fa fa-circle" aria-hidden="true"></i>&nbsp;<a href="avp.php">Exportar Base de datos histórica</a></li>
