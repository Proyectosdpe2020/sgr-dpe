...
SELECT DISTINCT c.NUC AS 'NUC',  
	...
	CASE 
		WHEN dbo.VictimaOfendido.Denunciante=1 THEN 'Denunciante'
		WHEN dbo.VictimaOfendido.Victima=1 THEN 'Victima'
		WHEN dbo.VictimaOfendido.Ofendido=1 THEN 'Lesionado'
		WHEN dbo.VictimaOfendido.Anonimo=1 THEN 'Anonimo'
	END AS 'Calidad' ,
	vic.Nombre AS 'Nombre Victima',
	vic.Paterno AS 'Paterno Vicitma',
	vic.Materno AS 'Materno Victima',
	c.Contar	
	FROM dbo.Carpeta c
	...
	WHERE 
		...
		and dbo.VictimaOfendido.Victima=1
